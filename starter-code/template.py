...
def batch_compare(prompts: list[str]) -> list[dict]:
    ...
    for prompt in prompts:
        try:
            ...
            results.append({
                "prompt": prompt,
                "gpt4o": {"response": f"Error: {e}", "latency": 0.0, "cost": 0.0, "input_tokens": 0,
                          "output_tokens": 0},
                "gpt4o_mini": {"response": f"Error: {e}", "latency": 0.0, "cost": 0.0, "input_tokens": 0,
                               "output_tokens": 0},
                "gemini_flash": {"response": f"Error: {e}", "latency": 0.0, "cost": 0.0, "input_tokens": 0,
                                 "output_tokens": 0}
            })
    return results
